...
Util.isScriptFile = function(filepath) {
  return scriptExtensionRegxp.test(filepath);
}

Util.stripScriptExtension = function(filepath) {
  return filepath.replace(scriptExtensionRegxp, "")
}
