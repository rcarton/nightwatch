...
Reporter.prototype.printTotalResults = function() {
  ...
  // Print no. of passed and failed unstable tests
  console.log(colors.yellow(
    format('Unstable tests: passed %s, failed %s', this.globalResults.unstable.passed, this.globalResults.unstable.failed)
  ));
};
